...
class _MerchantHomeScreenState extends State<MerchantHomeScreen> {
  ...
  void _onNavTap(int i) {
    if (i == 1) { context.go('/orders/current'); return; }
    if (i == 2) { context.go('/reports'); return; }
      ...
      children: [
        Row(
          ...
          children: [
            ...
            TextButton(
              onPressed: () => context.go('/orders/current'),
              child: Text(
